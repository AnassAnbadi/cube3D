    ...
    while (data->map[i])
    {
        ...
        while (data->map[i][j])
        {
            if (ft_isin(data->map[i][j], "NSEW"))
            {
                ...
                data->player.x = j + 0.5;
                data->player.y = i + 0.5;
                data->p_dir.x = -(data->map[i][j] == 'N') +(data->map[i][j] == 'S');
                data->p_dir.y = (data->map[i][j] == 'E') - (data->map[i][j] == 'W');
                data->plane.x = 0.66 * ((data->map[i][j] == 'E') - (data->map[i][j] == 'W'));
                data->plane.y = -0.66 * ((data->map[i][j] == 'N') + (data->map[i][j] == 'S'));
                data->map[i][j] = '0';
            }
            j++;
        }
